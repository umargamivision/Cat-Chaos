...
public class GVAnalysisManager : MonoBehaviour
{
    ...
    void Start()
    {
        // first initilize Game analytics then ADs.
#if USE_GAMEANALYTICS 
        GameAnalytics.onInitialize += OnGameAnalyticsInitialized; // GameAnalytics Initialization callback
        OnFirebaseInitialized.AddListener(() => { InitGameAnalytics(); }); 
#else
  OnFirebaseInitialized.AddListener(() => {  adController.StartAdController(); });
#endif 
    ...
    private void OnGameAnalyticsInitialized(object sender, bool e)
    {
        ...
        adController.StartAdController();
    }
    public void InitGameAnalytics()
    {
#if USE_GAMEANALYTICS
        IGameAnalyticsATTListener listener = new GVGameAnalyticsManager();
...
#if USE_GAMEANALYTICS 
    public class GVGameAnalyticsManager : IGameAnalyticsATTListener
    {
        public void GameAnalyticsATTListenerNotDetermined()
        {
            print("GameAnalyticsATTListenerNotDetermined");
            GameAnalytics.Initialize();
        }
        public void GameAnalyticsATTListenerRestricted()
        {
            print("GameAnalyticsATTListenerRestricted");
            GameAnalytics.Initialize();
        }
        public void GameAnalyticsATTListenerDenied()
        {
            print("GameAnalyticsATTListenerDenied");
            GameAnalytics.Initialize();
        }
        public void GameAnalyticsATTListenerAuthorized()
        {
            print("GameAnalyticsATTListenerAuthorized");
            GameAnalytics.Initialize();
        }
    }
#endif
    ...
    public void PaidAdAnalytics(string adString, MaxSdkBase.AdInfo adInfo)
    {
        ...
        Debug.Log($@"AdRevenue Event: Network = {adInfo.NetworkName},AdUnit = {adInfo.AdUnitIdentifier},Placement = {adInfo.Placement},Revenue = {adInfo.Revenue}");
#endif
    ...
    public void CustomEvent(string eventName)
    {
        ...
        try
        {
            Debug.Log("GV_Firebase_" + eventName);
