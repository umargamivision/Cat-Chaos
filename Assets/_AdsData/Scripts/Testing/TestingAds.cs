...
public class TestingAds : MonoBehaviour
{
    ...
    public void ShowAppOpen()
    {
        ...
        if (AdController.instance)
            AdController.instance.ShowAppLovinAppOpen("app_open_test");
#endif
    }
    ...
    {
        if (AdController.instance)
            AdController.instance.ShowBannerAd(AdController.BannerAdTypes.BANNER, "Test Banner");//(AdController.BannerAdTypes.BANNER);
    ...
    {
        if (AdController.instance)
            AdController.instance.ShowBannerAd(AdController.BannerAdTypes.ADAPTIVE, "Test Adaptive");//(AdController.BannerAdTypes.ADAPTIVE);
    }
    ...
    {
        if (AdController.instance)
            AdController.instance.ShowBannerAd(AdController.BannerAdTypes.NATIVE, "Test Mrec");// (AdController.BannerAdTypes.NATIVE);
    }
    ...
    public void TestEvent()
    {
        if (GVAnalysisManager.instance)
            GVAnalysisManager.instance.CustomEvent("Test Event Sent");
    }
}
