...
public class FirstPersonController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (m_MoveWithMouse)
        {
            ControlFreak2.CFCursor.lockState = lockCurser ? CursorLockMode.Locked : CursorLockMode.Confined;
        }
    ...
    private bool Move()
    {
        ...
        // Jump logic
        if (m_IsGrounded && ControlFreak2.CF2Input.GetButtonDown("Jump"))
        {
    ...
    private Vector2 GetLookInput()
    {
        ...
        if (m_MoveWithMouse)
        {
            mouseX = ControlFreak2.CF2Input.GetAxis("Mouse X") * m_MouseSensitivity * Time.deltaTime;
            mouseY = ControlFreak2.CF2Input.GetAxis("Mouse Y") * m_MouseSensitivity * Time.deltaTime;
        }
    ...
    private Vector3 GetMovementInput()
    {
        ...
        if (m_MoveWithMouse)
        {
            ...
            z = ControlFreak2.CF2Input.GetAxis("Vertical");
        }
